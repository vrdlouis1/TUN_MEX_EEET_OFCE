...
Yet, throughout the history of climate negotiations and successive COPs, a persistent antagonism has opposed the countries of the North and those of the South. The Global South has long presented itself as carrying a single voice vis-à-vis industrialised countries. However, if one opens this ``box'' of the South, one finds markedly different realities: small island states threatened with disappearance, large emerging economies with considerable economic power, but also intermediate countries with very diverse development trajectories. As far as the energy transition is concerned, these national specificities fundamentally condition the nature and magnitude of macroeconomic impacts. A fossil-fuel-importing developing country does not face the same challenges as an exporting one: for the former, the transition can represent an opportunity for energy sovereignty and a reduction of the external bill; for the latter, it implies a potentially costly process of industrial restructuring in the medium term.
